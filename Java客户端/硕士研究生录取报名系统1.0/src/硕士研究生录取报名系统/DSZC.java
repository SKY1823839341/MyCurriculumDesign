...
public class DSZC extends JFrame {
    /**
     *
     */
    ...
    public DSZC()
    {
        ...
        register.addActionListener(e -> {
            ...
            try {
                ...
                String  strSQL="(select * from  dbo.Teacher where Tno='"+user1+"' )";
                ...
                else
                {
                    if(!isValidCodeRight()) {
                        ...
                        if(rs.next())
                        {
                            JOptionPane.showMessageDialog(null,"该工号已被注册！","错误!", JOptionPane.ERROR_MESSAGE);
                        }
                        else
                        {
                            String sql = "insert into dbo.Teacher(Tno,Tpassword,Tname,Tsex) values('"+user1+"','"+pass1+"','"+id1+"','"+ph1+"') ";
