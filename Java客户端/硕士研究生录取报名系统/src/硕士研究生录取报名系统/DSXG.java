...
public class DSXG extends JFrame {
    /**
     *
     */
            ...
            try {
                ...
                else
                {
                    if(!isValidCodeRight()) {
                        ...
                        if(rs.next()) {
                            String sql = "update student set Tpassword='"+user1+"',Tname='"+pass1+"',Tsex='"+id1+"',phone='"+ph1+"' where Tno='"+U+"'  ";
